			...
			for ( const ticks of [ this.minTicks, this.midTicks, this.majTicks ] ) {
				if ( ticks && ticks.vals ) {
					...
					for ( let v = Math.ceil(ticks.min/ticks.vals)*ticks.vals;
									v <= ticks.max;
									v += ticks.vals ) {
						if ( ( !this.midTicks || !this.midTicks.vals || this.midTicks.vals<=ticks.vals || v % this.midTicks.vals ) &&
								( !this.majTicks || !this.majTicks.vals || this.majTicks.vals<=ticks.vals || v % this.majTicks.vals ) ) {
